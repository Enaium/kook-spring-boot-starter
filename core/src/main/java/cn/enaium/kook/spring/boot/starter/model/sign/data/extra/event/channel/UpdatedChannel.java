...
import cn.enaium.kook.spring.boot.starter.model.object.ChannelObject;
 ...
 */
@Listener
public class UpdatedChannel extends SystemMessageExtra<ChannelObject> {

    public static final String TYPE = "updated_channel";
