...
public class KookSpringBootStarter {
    ...
    private CommandLineRunner run() {
        return args -> {
            logger.info(" _  __           _     ____  _             _           ");
            logger.info("| |/ /___   ___ | | __/ ___|| |_ __ _ _ __| |_ ___ _ __");
            logger.info("| ' // _ \\ / _ \\| |/ /\\___ \\| __/ _` | '__| __/ _ \\ '__|");
            logger.info("| . \\ (_) | (_) |   <  ___) | || (_| | |  | ||  __/ |  ");
            logger.info("|_|\\_\\___/ \\___/|_|\\_\\|____/ \\__\\__,_|_|   \\__\\___|_|  ");
