 ...
 * @since 0.4.0
 */
public record DirectMessageReactionListResponse(@JsonProperty("code") Integer code,
    ...
    public record Data(@JsonProperty("id") String id, @JsonProperty("username") String username,
                       ...
                       @JsonProperty("avatar") String avatar, @JsonProperty("vip_avatar") String vipAvatar,
                       @JsonProperty("bot") Boolean bot, @JsonProperty("nickname") String nickname,
